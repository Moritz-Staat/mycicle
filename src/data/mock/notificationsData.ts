...
export const initialNotifications: AppNotification[] = [
  { id: '1', type: 'reminder', title: 'Temperatur messen', body: 'Guten Morgen! Heute ist ein wichtiger Messtag – miss deine Temperatur bevor du aufstehst.', timestamp: 'vor 20 Min.', read: false, lucideIcon: 'Thermometer', iconBg: 'bg-rose-100 text-rose-600' },
  ...
  { id: '7', type: 'insight', title: 'Neue Periodenprognose', body: 'Deine nächste Periode wird voraussichtlich am 1. Juni erwartet (80% Konfidenz).', timestamp: 'vor 4 Tagen', read: true, lucideIcon: 'Calendar', iconBg: 'bg-rose-100 text-rose-500' },
