  ...
  return (
    <aside className="hidden md:flex flex-col w-60 bg-white border-r border-gray-100 min-h-screen sticky top-0">
      ...
      <div className="flex items-center gap-2.5 px-5 py-5 border-b border-gray-100">
        ...
        <span className="text-lg font-bold text-gray-900">mycicle</span>
      </div>
      ...
      <div className="px-4 py-4 border-t border-gray-100">
        <div className="bg-amber-50 rounded-lg px-3 py-2.5 text-xs text-amber-700">
          <p className="font-semibold">Demo-Modus</p>
          <p className="mt-0.5 text-amber-600">Daten von Sarah M.</p>
        </div>
      </div>
    </aside>
  );
