...
export default function Wearables() {
  ...
  return (
    <div className="space-y-6">
      {/* Device cards */}
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Verbundene Geräte</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {devices.map((device) => (
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <h3 className="text-base font-semibold text-gray-900 mb-4">Heute (Oura Ring)</h3>
      ...
      {/* Correlation cards */}
      <div>
        <h3 className="text-base font-semibold text-gray-900 mb-4">KI-Korrelationen</h3>
